...
namespace Downpour
{
    ...
    public class DownpourPlugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            SimulacrumBase = Config.Bind("Difficulty Rework", "Simulacrum Scaling Seconds Base", 60f, "Base seconds to add/remove for simulacrum.");
            SimulacrumScaling = Config.Bind("Difficulty Rework", "Simulacrum Scaling Seconds Multiplier", 0.5f, "Multiplied to normal game scaling time. Lower = harder");
            SimulacrumTempScaling = Config.Bind("Difficulty Rework", "Simulacrum Temporary Scaling Seconds Multiplier", 1f, "Temporary scaling multiplier for simulacrum, takes simulacrum scaling.");
            ...
            SimulacrumScalingDownpour = Config.Bind("Downpour", "Downpour Simulacrum Scaling Seconds Multiplier", 0.5f, "Special exception.");
            SimulacrumTempScalingDownpour = Config.Bind("Downpour", "Downpour Simulacrum Temporary Scaling Seconds Multiplier", 2f, "Special exception.");
            ...
            SimulacrumScalingBrimstone = Config.Bind("Downpour", "Brimstone Simulacrum Scaling Seconds Multiplier", 0.5f, "Special exception.");
            ...
            Hooks.Patch();
            if (FasterSimulacrum.Value) Hooks.PatchSimulacrum();
            On.RoR2.InfiniteTowerWaveController.Initialize += (orig, self, index, inv, target) =>
            {
                self.secondsAfterWave = (int)(DownpourList.Contains(DifficultyCatalog.GetDifficultyDef(Run.instance.selectedDifficulty)) ? SimulacrumCountdownDownpour.Value : SimulacrumCountdown.Value);
        ...
        {
            Downpour = new(2f, "DOWNPOUR_TITLE", "DOWNPOUR_ICON", "DOWNPOUR_DESC", new Color32(98, 157, 230, 255), "DP", false);
        ...
        {
            Brimstone = new(3f, "BRIMSTONE_TITLE", "BRIMSTONE_ICON", "BRIMSTONE_DESC", new Color32(213, 145, 242, 255), "BS", false);
